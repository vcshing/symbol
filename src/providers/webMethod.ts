...
export class WebMethod {
  ...
  GetSymbolType(page,selectTypeItem,type2,favoriteList,lang): Observable<SymbolType[]> {
      var url = 'http://gogogo.synology.me/api/symbol/gettype.php?page='+page+'&type='+selectTypeItem +'&id='+favoriteList + '&type2=' + type2 +'&lang=' + lang;
      return this.http.get(url)
